...
const Benefits = ({ className }: { className?: string }) => {
  return (
    <section
      className={cn(
        "w-full py-14 md:py-20 xl:py-28 2xl:flex 2xl:items-center 2xl:justify-center 2xl:px-80 2xl:py-40",
        className,
      )}
    >
