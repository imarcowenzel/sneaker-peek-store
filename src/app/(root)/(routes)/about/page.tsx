...
const AboutPage = () => {
  ...
  return (
    ...
    <section className="min-w-[375px]">
      ...
      <article className="w-full bg-cover bg-fixed bg-center px-8 py-14 lg:px-20 xl:py-0 2xl:p-14 flex flex-col justify-center items-center">

        <Benefits />

        <div className="mx-auto flex max-w-4xl flex-col gap-y-9 md:max-w-5xl pb-36 md:items-center md:text-center xl:mx-0 justify-center w-full lg:max-7xl">
