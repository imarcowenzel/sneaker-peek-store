    ...
    <section className="min-h-[100dvh]">
      ...
      <article className="px-5 py-8 md:p-12">
        <div className="mx-auto flex w-full max-w-3xl md:max-w-5xl lg:max-w-6xl 2xl:max-w-7xl">
          <div
            className="flex w-full flex-col item-start rounded-xl bg-cover bg-no-repeat px-9 pb-11 pt-40 font-black text-white md:p-12 md:pt-52 lg:px-20 lg:pb-28 lg:pt-72"
